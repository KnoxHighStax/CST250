            ...
            while (!death)
            {
                ...
                switch (action)
                {
                    ...
                    case "V":
                        ...
                        // use FloodFill if cell has no bomb neighbors
                        if (selectedCell.NumberOfBombNeighbors == 0)
                        {
        ...
        private static void PrintBoard(Board board)
        {
            ...
            for (int row = 0; row < board.Size; row++)
            {
                ...
                for (int col = 0; col < board.Size; col++)
                {
                    ...
                    // Determine what we display based on the state of the cell
                    if (cell.IsFlagged)
                    {
        ...
        static void PrintAnswers(Board board)
        {
            ...
            for (int row = 0; row < board.Size; row++)
            {
                ...
                for (int col = 0; col < board.Size; col++)
                {
                    ...
                    // To always show the true cells state
                    if (cell.IsBomb)
                    {
                        Console.ForegroundColor = ConsoleColor.Red;
                        Console.Write("B");
